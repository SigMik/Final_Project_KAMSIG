...
# sns.barplot(data=sortwdf[:1], x="Player", y="Result", hue='Result', palette=None, width=0.2)
...
# sns.barplot(data=sortwdf[:3], x="Player", y="Resultefficiency", hue = 'Team', palette = None, alpha =.4)
